...
export const AboutContent: Language = {
    ...
    cards: [
        ...
        },
        {
            ...
            subtitle: {
                en: '5+ Completed Projects',
                es: '5+ Proyectos Completos',
            },
        },
    ],
    paragraph: {
        en: `Who am I 👀<br />
            ...
            <br />
            My work history 😉<br />
            🔸 My experience has been mainly in the academic field, for 3 years I dedicated myself to the study of systems engineering where I learned solid foundations in algorithms and data structures management. Currently I work as a Junior Full-Stack Developer at Proguide Global Services, and tutoring at Numen Academy.`,
        es: `Quien soy? 👀<br />
